    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.div2}>
          <a href="https://www.facebook.com/trySUGAR/" target="_blank">
            <img
              className={styles.imgdiv1}
              src="https://in.sugarcosmetics.com/desc-images/facebook.svg"
              alt=""
            />
          </a>
          <a href="https://twitter.com/trySUGAR" target="_blank">
            <AiOutlineTwitter color="#999999" fontSize="25px" />
          </a>
          ...
          <a href="https://www.pinterest.com/sugarcosmetics/" target="_blank">
            <img
              className={styles.imgdiv1}
          ...
          <a href="https://sugarcosmetics-blog.tumblr.com/" target="_blank">
            <img
              className={styles.imgdiv1}
        ...
        >
          <div style={{ display: "flex", marginTop: "30px" }}>
            <a href="https://in.sugarcosmetics.com/stores" target="_blank">
              Stores
            </a>
            <a
            ...
            <a
              href="https://in.sugarcosmetics.com/pages/about-us"
              target="_blank"
            >
              About Us
            </a>
        ...
        <div style={{ marginLeft: "90px", marginTop: "25px" }}>
          <p style={{ color: "white", fontSize: "24px", textAlign: "left" }}>
            GET IN TOUCH
          </p>
        </div>
        <div
          className={styles.ugly}
          style={{
            marginLeft: "90px",
            marginTop: "5px",
            display: "flex",
        ...
        >
          <div>
            <div style={{ display: "flex" }}>
              ...
              />
              <p
                style={{ color: "white", fontSize: "18px", fontWeight: "540" }}
              >
                Call us at
              </p>
            </div>
          ...
          <div>
            ...
            <a
              ...
              href="https://in.sugarcosmetics.com/careers"
            >
              <p
                style={{
                  fontSize: "18px",
          ...
          <div>
            ...
            <a
              href="https://blog.sugarcosmetics.com/collab"
              target="_blank"
              style={{ textDecoration: "none" }}
            >
              <p
          ...
          <div className={styles.div3}>
            <div className={styles.innerdiv3}>
              ...
              <div style={{ display: "flex", gap: "20px" }}>
                <a
                  href="https://sugarcosmetics.app.link/WebFApp"
                  target="_blank"
                >
                  <img
                    style={{
        ...
        <div className={styles.cpr}>
          <h3>Copyright © 2022 SUGAR Cosmetics. All rights reserved.</h3>
        </div>
      </div>
    </>
  );
