      ...
      <div className={styles.navbottom}>
        <div className={styles.div3}>
          <div className={styles.makeup}>
            <Link to="/makeup" style={{ fontSize: "14px" }} id={styles.link}>
              Makeup
            </Link>
          ...
          <div className={styles.makeup}>
            <Link to="/brushes" style={{ fontSize: "14px" }} id={styles.link}>
              Brushes
            </Link>
            <div className={styles.dropdown1}>
          ...
          <div className={styles.makeup}>
            <Link to="/skincare" style={{ fontSize: "14px" }} id={styles.link}>
              Skincare
            </Link>
            <div className={styles.dropdown1}>
          ...
          <div className={styles.makeup}>
            <Link to="/trending" style={{ fontSize: "14px" }} id={styles.link}>
              Trending
            </Link>
            <div className={styles.dropdown1}>
          ...
          <div>
            <Link to="/blog" style={{ fontSize: "14px" }} id={styles.link}>
              Blog
            </Link>
          </div>
          <div>
            <Link to="/offers" style={{ fontSize: "14px" }} id={styles.link}>
              Offers
            </Link>
          </div>
          <div>
            <Link to="/stores" style={{ fontSize: "14px" }} id={styles.link}>
              Stores
            </Link>
          </div>
          <div>
